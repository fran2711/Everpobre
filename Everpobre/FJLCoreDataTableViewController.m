...
@interface FJLCoreDataTableViewController()
@property (nonatomic) BOOL beganUpdates;
@end

@implementation FJLCoreDataTableViewController
...
-(void) motionEnded:(UIEventSubtype)motion
    ...
    if (motion == UIEventSubtypeMotionShake) {
        ...
        //Se ha producido una sacudida para eliminar el objeto
        //[self.fetchedResultsController.managedObjectContext.undoManager undo];
        
        
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle: @"Deshacer"
                                                        message: @"Vas ha deshacer los cambios"
                                                       delegate: self
...
-(void) alertView: (UIAlertView *) alerta clickedButtonAtIndex:(NSInteger)buttonIndex{
...
-(void) tableView:(UITableView *) tableView didSelectRowAtIndexPath:(nonnull NSIndexPath *)indexPath{
    ...
    UITableViewController<FJLDetailViewController> *detailVC = [[NSClassFromString(self.detailViewControllerClassName) alloc] initWithModel: detailModel];
