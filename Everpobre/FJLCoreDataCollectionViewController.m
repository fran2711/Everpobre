...
@interface FJLCoreDataCollectionViewController ()<NSFetchedResultsControllerDelegate>
@property (strong, nonatomic) NSMutableArray *objectChanges;
@property (strong, nonatomic) NSMutableArray *sectionChanges;

@end

@implementation FJLCoreDataCollectionViewController
...
-(void) collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    UIViewController<FJLDetailViewController> *detailVC = [[NSClassFromString(self.detailViewControllerClassName) alloc] initWithModel: detailModel];
